...
export default function SixthSub() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <div className="w-16 h-16 bg-gradient-to-br from-red-400 to-red-500 rounded-xl flex items-center justify-center mr-4">
              <span className="text-white font-bold text-2xl">৬</span>
            </div>
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">
                {language === 'bn' ? 'ষষ্ঠ শ্রেণী' : 'Class 6'}
              </h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-12">
          {subjects.map((subject) => (
            <Link key={subject.id} href={`/learn/class-6/${subject.id}`}>
